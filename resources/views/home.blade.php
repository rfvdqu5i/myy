...
@section('content')
	...
	<div class="banner">
		<div class="banner_background" style="background-image:url({{ asset('shop_assets/images/banner_background.jpg') }})"></div>
		<div class="container fill_height">
			<div class="row fill_height">
				<div class="banner_product_image"><img src="{{ asset('shop_assets/images/banner_product.png') }}" alt=""></div>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						<div class="char_icon"><img src="{{ asset('shop_assets/images/char_1.png') }}" alt=""></div>
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						<div class="char_icon"><img src="{{ asset('shop_assets/images/char_2.png') }}" alt=""></div>
						<div class="char_content">
							<div class="char_title">Free Delivery</div>
							<div class="char_subtitle">from $50</div>
						</div>
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						<div class="char_icon"><img src="{{ asset('shop_assets/images/char_3.png') }}" alt=""></div>
						<div class="char_content">
							<div class="char_title">Free Delivery</div>
							<div class="char_subtitle">from $50</div>
						</div>
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						<div class="char_icon"><img src="{{ asset('shop_assets/images/char_4.png') }}" alt=""></div>
						<div class="char_content">
							<div class="char_title">Free Delivery</div>
							<div class="char_subtitle">from $50</div>
						</div>
						...
						<div class="deals_slider_container">
							...
							<div class="owl-carousel owl-theme deals_slider">
								...
								<div class="owl-item deals_item">
									<div class="deals_image"><img src="{{ asset('shop_assets/images/deals.png') }}" alt=""></div>
			...
			<div class="row">
				...
				<div class="col-lg-4 advert_col">
					...
					<div class="advert d-flex flex-row align-items-center justify-content-start">
						...
						<div class="ml-auto"><div class="advert_image"><img src="{{ asset('shop_assets/images/adv_1.png') }}" alt=""></div></div>
					</div>
				</div>
				...
				<div class="col-lg-4 advert_col">
					...
					<div class="advert d-flex flex-row align-items-center justify-content-start">
						...
						<div class="ml-auto"><div class="advert_image"><img src="{{ asset('shop_assets/images/adv_2.png') }}" alt=""></div></div>
					</div>
				</div>
				...
				<div class="col-lg-4 advert_col">
					...
					<div class="advert d-flex flex-row align-items-center justify-content-start">
						...
						<div class="ml-auto"><div class="advert_image"><img src="{{ asset('shop_assets/images/adv_3.png') }}" alt=""></div></div>
					</div>
				</div>
	...
	<div class="trends">
		<div class="trends_background" style="background-image:url({{ asset('shop_assets/images/trends_background.jpg') }})"></div>
						...
						<div class="owl-carousel owl-theme trends_slider">
							...
							<div class="owl-item">
								<div class="trends_item is_new">
									<div class="trends_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset('shop_assets/images/trends_1.jpg') }}" alt=""></div>
							...
							<div class="owl-item">
								<div class="trends_item">
									<div class="trends_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset('shop_assets/images/trends_2.jpg') }}" alt=""></div>
									<div class="trends_content">
										<div class="trends_category"><a href="#">Smartphones</a></div>
										<div class="trends_info clearfix">
							...
							<div class="owl-item">
								<div class="trends_item is_new">
									<div class="trends_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset('shop_assets/images/trends_3.jpg') }}" alt=""></div>
									<div class="trends_content">
										<div class="trends_category"><a href="#">Smartphones</a></div>
										<div class="trends_info clearfix">
						...
						<div class="owl-carousel owl-theme reviews_slider">
							...
							<div class="owl-item">
								<div class="review d-flex flex-row align-items-start justify-content-start">
									<div><div class="review_image"><img src="{{ asset('shop_assets/images/review_1.jpg') }}" alt=""></div></div>
							...
							<div class="owl-item">
								<div class="review d-flex flex-row align-items-start justify-content-start">
									<div><div class="review_image"><img src="{{ asset('shop_assets/images/review_2.jpg') }}" alt=""></div></div>
									<div class="review_content">
							...
							<div class="owl-item">
								<div class="review d-flex flex-row align-items-start justify-content-start">
									<div><div class="review_image"><img src="{{ asset('shop_assets/images/review_3.jpg') }}" alt=""></div></div>
									<div class="review_content">
						...
						<div class="owl-carousel owl-theme viewed_slider">
							...
							<div class="owl-item">
								<div class="viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
									<div class="viewed_image"><img src="{{ asset('shop_assets/images/view_1.jpg') }}" alt=""></div>
							...
							<div class="owl-item">
								<div class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
									<div class="viewed_image"><img src="{{ asset('shop_assets/images/view_2.jpg') }}" alt=""></div>
									<div class="viewed_content text-center">
							...
							<div class="owl-item">
								<div class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
									<div class="viewed_image"><img src="{{ asset('shop_assets/images/view_3.jpg') }}" alt=""></div>
									<div class="viewed_content text-center">
							...
							<div class="owl-item">
								<div class="viewed_item is_new d-flex flex-column align-items-center justify-content-center text-center">
									<div class="viewed_image"><img src="{{ asset('shop_assets/images/view_4.jpg') }}" alt=""></div>
									<div class="viewed_content text-center">
										<div class="viewed_price">$379</div>
							...
							<div class="owl-item">
								<div class="viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
									<div class="viewed_image"><img src="{{ asset('shop_assets/images/view_5.jpg') }}" alt=""></div>
									<div class="viewed_content text-center">
										<div class="viewed_price">$225<span>$300</span></div>
							...
							<div class="owl-item">
								<div class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
									<div class="viewed_image"><img src="{{ asset('shop_assets/images/view_6.jpg') }}" alt=""></div>
									<div class="viewed_content text-center">
