...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('admin_assets/bower_components/magicsearch/jquery.magicsearch.css')}}">
...
<aside class="main-sidebar">
	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu" data-widget="tree">
			<li @if(Request::is('admin/tags*')) class="active" @endif class="treeview">
			...
			<li {{-- @if(Request::is('admin/tags*')) class="active" @endif --}}>
				<a href="{{ asset('admin/tags') }}">
					<i class="fa fa-dashboard"></i> <span>Quản lý tag</span>
				</a>
			</li>
		</ul>
	</section>
...
<!-- /.control-sidebar -->
	...
	<!-- Magic Search -->
	<script src="{{ asset('admin_assets/bower_components/magicsearch/jquery.magicsearch.min.js')}}"></script>
